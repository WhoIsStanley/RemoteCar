...
//#define TIM2_CH3_PWM_PIN 				GPIO_Pin_10 ** datasheet TM3 CH1 partial ** => rightC
	...
	timerInitStructure.TIM_Prescaler = 72-1; // (72Mhz/144)=50000Hz
...
void TIM2_CH2_IC2_init(void) {
	...
	// Configure I/O for IC2
	GPIO_InitStruct.GPIO_Pin = TIM2_CH2_IT2_PIN;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_Init(TIM2_CH2_IT2_GPIO, &GPIO_InitStruct);

	//Enable Tim2 Ch2 Input Capture
	TIM_ICInitTypeDef InputCaptureInitStructure;
	InputCaptureInitStructure.TIM_Channel = TIM_Channel_2; //Seclect IC2
	...
	TIM_ICInit(TIM2, &InputCaptureInitStructure);
